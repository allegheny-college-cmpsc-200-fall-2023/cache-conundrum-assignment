...
#define CACHE_HITS  0x1400000c
#define CACHE_ACCS  0x14000010
...
typedef float (*func_ptr_t_mat)(int **mat, int n);

func_ptr_t_mat averageMat_v1_nocache = (func_ptr_t_mat) ((int)averageMat_v1 - CACHE_BASE) + CACHE_BYPASS;
func_ptr_t_mat averageMat_v2_nocache = (func_ptr_t_mat) ((int)averageMat_v1 - CACHE_BASE) + CACHE_BYPASS;